...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    staking: {
      ...
      investmentStrategy: 'The projects invested in AlphaBag aim to safely increase profits through diversified investment. The projects recommend diversified investment according to the 40% : 40% : 20% rule with BBAG, SBAG which is a Binance Alpha project, and the safer CBAG.',
  ...
  zh: {
    ...
    staking: {
      ...
      investmentStrategy: 'AlphaBag 的投资项目旨在通过分散投资安全地增加利润。项目建议按照 40% : 40% : 20% 的规则，在 BBAG、币安 Alpha 项目 SBAG 以及更安全的 CBAG 之间进行分散投资。',
      amountToInvest: '投资金额',
      max: '最大',
      invest: '投资',
      approving: '批准中...',
  ...
  ko: {
    ...
    staking: {
      ...
      investmentStrategy: 'AlphaBag에 투자된 프로젝트는 분산 투자를 통해 안전하게 수익을 증가시키는 것을 목표로 합니다. 프로젝트는 바이낸스 Alpha 프로젝트인 BBAG, SBAG 및 더 안전한 CBAG와 함께 40% : 40% : 20% 규칙에 따라 분산 투자를 권장합니다.',
